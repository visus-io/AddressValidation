...
{
    private const string s_customResponseDataPropertyAttribute = "Visus.AddressValidation.CustomResponseDataPropertyAttribute";

    private const string s_getCustomResponseDataMethodName = "GetCustomResponseData";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        IncrementalValuesProvider<PropertyInfo?> propertyProvider =
            context.SyntaxProvider.ForAttributeWithMetadataName(
                s_customResponseDataPropertyAttribute,
    ...
    private static void GenerateSource(SourceProductionContext context, ImmutableArray<PropertyInfo?> properties)
    {
        ...
        foreach ( IGrouping<string, PropertyInfo>? group in groups )
        {
            ...
            MethodDeclarationSyntax methodDeclaration =
                MethodDeclaration(GetDictionaryMethodSyntax(), s_getCustomResponseDataMethodName)
            ...
            context.AddSource($"{safeKey}_{s_getCustomResponseDataMethodName}.g.cs", compilationUnit.ToFullString());
        }
    }
