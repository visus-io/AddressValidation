...
/// <summary>
///     Extension methods that register Pitney Bowes address validation services with an
...
public static class ServiceCollectionExtensions
{
    ...
    /// <remarks>
    ///     This method loads options from the <c>AddressValidationSettings:PitneyBowes</c> configuration section
    ///     (see <see cref="PitneyBowesServiceOptions.SectionName" />). It validates them at application startup.
    /// </remarks>
