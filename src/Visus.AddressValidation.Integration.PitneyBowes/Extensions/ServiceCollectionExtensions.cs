...
public static class ServiceCollectionExtensions
{
    ...
    /// <remarks>
    ///     Options are loaded from the <c>AddressValidationSettings:PitneyBowes</c> configuration section
    ///     (see <see cref="PitneyBowesServiceOptions.SectionName" />) and validated at application startup.
    /// </remarks>
