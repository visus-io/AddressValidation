...
/// <summary>
///     Extension methods that register UPS address validation services with an <see cref="IServiceCollection" />.
/// </summary>
public static class ServiceCollectionExtensions
{
    ...
    /// <remarks>
    ///     This method loads options from the <c>AddressValidationSettings:Ups</c> configuration section (see
    ///     <see cref="UpsServiceOptions.SectionName" />). It validates them at application startup.
    /// </remarks>
    public static IServiceCollection AddUpsAddressValidation(this IServiceCollection services)
    {
        ...
        services.AddOptions<UpsServiceOptions>()
                .BindConfiguration(UpsServiceOptions.SectionName)
                .ValidateOnStart();
