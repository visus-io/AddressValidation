...
/// <summary>
///     Extension methods that register Google address validation services with an <see cref="IServiceCollection" />.
/// </summary>
public static class ServiceCollectionExtensions
{
    ...
    /// <remarks>
    ///     This method loads options from the <c>AddressValidationSettings:Google</c> configuration section (see
    ///     <see cref="GoogleServiceOptions.SectionName" />). It validates them at application startup.
    /// </remarks>
